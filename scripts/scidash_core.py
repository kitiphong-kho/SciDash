...
ACADEMIC_STAFF = [
    ...
    staff_record("Ajarn Dr. Amorn Owatworakit", "Bioscience"),
    ...
    staff_record("Ajarn Dr. Kritsakorn Saninjuk", "Bioscience"),
    staff_record("Ajarn Dr. Naritsada Thongklang", "Bioscience"),
    staff_record("Ajarn Dr. Natthawut Yodsuwan", "Bioscience"),
